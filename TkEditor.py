...
def about():
    tkinter.messagebox.showinfo("About", "A Editor using Tkinter by Raj")


def help_box(event=None):
    tkinter.messagebox.showinfo("Help", "For help email to rajpatra.kishore@gmail.com", icon='question')
